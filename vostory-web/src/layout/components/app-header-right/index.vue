    ...
    <div class="app-header-right">
        <div class="right-side">
            ...
            <a-dropdown trigger="hover">
                <a-link>{{ global().userInfo?.user_name }}</a-link>
                <template #content>
...
import { updateCurrentUserPassword } from "@/config/apis/system";
import { encryptPassword } from "@/views/utils";
...
function changepassword() {
    ...
    ArcoModalFormShow({
                ...
                rules: [
                    {
                        ...
                        validator: (value: string, callback) => {
                            ...
                            if (value !== changeData?.newPassword) {
                                callback("两次密码不一致");
                                return;
                            }
                            callback();
        ...
        ok: async (data) => {
            await updateCurrentUserPassword(encryptPassword(data.oldPassword), encryptPassword(data.newPassword));
