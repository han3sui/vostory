    ...
    <frame-view>
        <div class="flex h-full">
            ...
            <div class="w-60 border-r border-gray-200 overflow-y-auto p-3">
                <div class="mb-3">
                    <a-select v-model="selectedProjectId" placeholder="选择项目" allow-clear @change="loadChapters">
                ...
                <a-empty v-if="chapters.length === 0 && selectedProjectId" description="暂无章节" />
            </div>
...
async function loadChapters() {
    ...
    const res: any = await request({
        url: `/api/v1/common/chapter/project/${selectedProjectId.value}`
    });
    chapters.value = res || [];

    characterOptions.value = await getCharactersByProject(selectedProjectId.value);
}
